...
export default function Navbar() {
  ...
  function appRedirect() {
    window.location.href = "/assets/video/IMG_0179.mp4";
  }
  ...
  return (
    <header className="fixed top-0 w-full px-10 pb-5 font-thin text-white bg-red pt-7 bg-opacity-70 backdrop-blur-sm navBar">
      ...
      <div className="inline-block align-middle">
        <Link href={"/"}>
          <Image
            src="/assets/imgs/cpc logo background free.png"
            alt="Otto Logo"
            width={107}
            height={1}
            priority
      ...
      <nav className="hidden text-center md:inline-block topnav-centered">
        ...
        <Link onClick={docsRedirect} href="" className="">
      ...
      <div className="inline-block float-right align-middle">
        <button
          onClick={appRedirect}
          className="inline-flex items-center justify-center w-auto h-auto py-3 text-white rounded-full px-7 bg-primary-gradient"
        >
          Launch Video
        </button>
      </div>
